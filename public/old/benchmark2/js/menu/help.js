...
var helpState = {
  	create: function(){
        ...
        var playerHelpString ="Your ship dies if hit:" + "\nuse your paddle to reflect shots!" + "\nIf your paddle takes too many hits," + "\nit will need some repair time!";
        var enemyHelpString ="The bad guys can shoot," + "\nbut have no defenses!";
        var powerHelpString ="Keep an eye out for power ups" + "\nthat can give you an extra advantage!";
        ...
        var player_description = game.add.text(400, 500, playerHelpString, {font: 'Tahoma', fontSize: '14px', fill: '#ffce00' });
        ...
        var enemy_description = game.add.text(175, 475, enemyHelpString, {font: 'Tahoma', fontSize: '14px', fill: '#ffce00' });
		enemy_description.anchor.setTo(0.5,0.5);
        enemy_description.align = 'center';

        var power_help = game.add.sprite(650, 400, 'placeholder');
		power_help.anchor.setTo(0.5,0.5);
        var power_description = game.add.text(650, 475, powerHelpString, {font: 'Tahoma', fontSize: '14px', fill: '#ffce00' });
