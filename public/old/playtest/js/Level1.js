...
Level1.prototype.create = function() {
   ...
   //stickBullet
	...
	//this.powerUp =this.add.sprite(this.world.centerX, this.world.centerY+300, "selfSpaceship");
...
//    };
   ...
   if(powerCounter < 30){
	 powerCounter++;
		...
		powerUp =this.add.sprite(this.world.centerX, this.world.centerY-200, "powerup");
    	powerUp.arcade.enable(this.powerUp);
	   ...
	   powerCounter=0;
	   console.log("power counter reset");
   }
...
//	if(!stickBullet.alive){
	    if (!stick){
	    	...
	    	stickBullet.reset(board.x,board.y-20);
