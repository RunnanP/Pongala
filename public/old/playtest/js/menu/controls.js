...
var controlState = {
  	create: function(){
        ...
        helpText = game.add.text(550, 275, "Paddle controls (Level 2 and up)", {font: 'Tahoma', fontSize: '16px', fill: '#ffce00' });
        helpText.anchor.setTo(0.5,0.5);
        helpText.fontWeight = 'bold';
        helpText.align = 'center';
        ...
        var catchButton = this.game.add.button(500,400,"select_button",undefined,this, 1, 1, 1);
		catchButton.anchor.setTo(0.5,0.5);
        var text = game.add.text(0, 0, "F", {font: "30px Arial", fill: "#ffffff"});
		text.anchor.setTo(0.5,0.5);
        catchButton.addChild(text);
		
        catchButton = this.game.add.button(600,400,"select_button",undefined,this, 1, 1, 1);
		catchButton.anchor.setTo(0.5,0.5);
        var text = game.add.text(0, 0, "R", {font: "30px Arial", fill: "#ffffff"});
		text.anchor.setTo(0.5,0.5);
        catchButton.addChild(text);

        helpText = game.add.text(550, 475, "Catch and Release (WIP)", {font: 'Tahoma', fontSize: '16px', fill: '#ffce00' });
        helpText.anchor.setTo(0.5,0.5);
        helpText.fontWeight = 'bold';
        helpText.align = 'center';
	},
